...
export namespace AttachProcess {
	...
	export const selectProcessPlaceholder = l10n.t(
...
export namespace DebugConfigStrings {
	...
	export namespace fileWithArgs {
		...
		export const selectConfiguration = {
			...
			description: l10n.t(
				"Debug the currently active Python file with arguments",
			),
		};
	}
...
export namespace Common {
	export const loadingExtension = l10n.t(
		"Python Debugger extension loading...",
	);
...
export namespace pickArgsInput {
	...
	export const prompt = l10n.t(
		"Enter the command line arguments you want to pass to the program",
	);
}
