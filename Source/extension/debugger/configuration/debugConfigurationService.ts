		...
		const items: DebugConfigurationQuickPickItem[] = [
			{
				...
				description:
					DebugConfigStrings.file.selectConfiguration.description,
			},
			{
				label: DebugConfigStrings.fileWithArgs.selectConfiguration
					.label,
				type: DebugConfigurationType.launchFileWithArgs,
				description:
					DebugConfigStrings.fileWithArgs.selectConfiguration
						.description,
			},
			{
